        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsMembershipActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    MembershipDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EventCreationLimit = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventArtPieces", x => new { x.EventId, x.ArtPieceId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventArtPieces_Events_EventId",
                        column: x => x.EventId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventArtPieces_ArtPieceId",
